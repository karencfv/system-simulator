...
- The average on lighter load is ~6608681 which is higher than the average on medium (15 clients and ~3991609ns), high (125 clients and ~4760868ns), and max (1000 clients and ~3384652ns). It is interesting how when running 1000 clients at the same time, the total of requests processed goes down to ~3800 from ~4666 when I was running 125 clients (at 125 clients some requests are still not being blocked).
...
### Running network transactions script using 1 client
...
### Running network transactions script using 15 clients
...
### Running network transactions script using 125 clients
